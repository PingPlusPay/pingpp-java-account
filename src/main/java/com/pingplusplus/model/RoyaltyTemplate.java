...
public class RoyaltyTemplate extends AccountAPIResource {
    ...
    public static RoyaltyTemplate create(Map<String, Object> params) throws AuthenticationException,
        ...
        return request(RequestMethod.POST, classURL(RoyaltyTemplate.class), params, RoyaltyTemplate.class);
    }
    ...
    public static RoyaltyTemplate retrieve(String id) throws AuthenticationException,
            InvalidRequestException, APIConnectionException,
            APIException, ChannelException, RateLimitException {
        return request(RequestMethod.GET, instanceURL(RoyaltyTemplate.class, id), null, RoyaltyTemplate.class);
    }
    ...
    public static RoyaltyTemplateCollection list(Map<String, Object> params)
        ...
        return request(RequestMethod.GET, classURL(RoyaltyTemplate.class), params, RoyaltyTemplateCollection.class);
    }
    ...
    public static DeleteRoyaltyTemplate delete(String id)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.DELETE, instanceURL(RoyaltyTemplate.class, id), null, DeleteRoyaltyTemplate.class);
    }
    ...
    public static RoyaltyTemplate update(String id, Map<String, Object> params)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.PUT, instanceURL(RoyaltyTemplate.class, id), params, RoyaltyTemplate.class);
    }
}
