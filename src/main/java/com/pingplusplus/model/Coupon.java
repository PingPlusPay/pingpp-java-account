...
public class Coupon extends UserBasedResource {
    ...
    public static Coupon create(String userId, Map<String, Object>params)
        ...
        return request(RequestMethod.POST, classURL(Coupon.class, userId), params, Coupon.class);
    }
    ...
    public static Coupon retrieve(String userId, String id)
            ...
            APIConnectionException, APIException, ChannelException, RateLimitException {
        User.checkUserId(userId);
        return request(RequestMethod.GET, instanceURL(Coupon.class, userId, id), null, Coupon.class);
    }
    ...
    public static CouponCollection list(String userId, Map<String, Object> params)
            ...
            APIConnectionException, APIException, ChannelException, RateLimitException {
        User.checkUserId(userId);
        return request(RequestMethod.GET, classURL(Coupon.class, userId), params, CouponCollection.class);
    }
    ...
    public static Coupon update(String userId, String id, Map<String, Object>params)
            ...
            APIConnectionException, APIException, ChannelException, RateLimitException {
        User.checkUserId(userId);
        return request(RequestMethod.PUT, instanceURL(Coupon.class, userId, id), params, Coupon.class);
    }
    ...
    public static DeletedCoupon delete(String userId, String id)
            ...
            APIConnectionException, APIException, ChannelException, RateLimitException {
        User.checkUserId(userId);
        return request(RequestMethod.DELETE, instanceURL(Coupon.class, userId, id), null, DeletedCoupon.class);
    }
}
