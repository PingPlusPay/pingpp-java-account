...
public class SettleAccount extends UserBasedResource {
    ...
    public static SettleAccount create(String userId, Map<String, Object>params)
        ...
        return request(RequestMethod.POST, classURL(SettleAccount.class, userId), params, SettleAccount.class);
    }
    ...
    public static SettleAccount retrieve(String userId, String id)
            ...
            APIConnectionException, APIException, ChannelException, RateLimitException {
        User.checkUserId(userId);
        return request(RequestMethod.GET, instanceURL(SettleAccount.class, userId, id), null, SettleAccount.class);
    }
    ...
    public static SettleAccountCollection list(String userId, Map<String, Object> params)
            ...
            APIConnectionException, APIException, ChannelException, RateLimitException {
        User.checkUserId(userId);
        return request(RequestMethod.GET, classURL(SettleAccount.class, userId), params, SettleAccountCollection.class);
    }
    ...
    public static DeletedSettleAccount delete(String userId, String id)
            ...
            APIConnectionException, APIException, ChannelException, RateLimitException {
        User.checkUserId(userId);
        return request(RequestMethod.DELETE, instanceURL(SettleAccount.class, userId, id), null, DeletedSettleAccount.class);
    }
}
