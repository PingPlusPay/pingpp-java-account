...
public class RoyaltySettlement extends AccountAPIResource {
    ...
    public static RoyaltySettlement create(Map<String, Object> params) throws AuthenticationException,
        ...
        return request(RequestMethod.POST, classURL(RoyaltySettlement.class), params, RoyaltySettlement.class);
    }
    ...
    public static RoyaltySettlement retrieve(String id) throws AuthenticationException,
            InvalidRequestException, APIConnectionException,
            APIException, ChannelException, RateLimitException {
        return request(RequestMethod.GET, instanceURL(RoyaltySettlement.class, id), null, RoyaltySettlement.class);
    }
    ...
    public static RoyaltySettlementCollection list(Map<String, Object> params)
        ...
        return request(RequestMethod.GET, classURL(RoyaltySettlement.class), params, RoyaltySettlementCollection.class);
    }
    ...
    public static RoyaltySettlement update(String id, Map<String, Object> params)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.PUT, instanceURL(RoyaltySettlement.class, id), params, RoyaltySettlement.class);
    }
}
