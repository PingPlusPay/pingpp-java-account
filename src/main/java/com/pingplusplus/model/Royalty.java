...
public class Royalty extends AccountAPIResource {
    ...
    public static Royalty retrieve(String id) throws AuthenticationException,
        ...
        return request(RequestMethod.GET, instanceURL(Royalty.class, id), null, Royalty.class);
    }
    ...
    public static RoyaltyCollection list(Map<String, Object> params)
        ...
        return request(RequestMethod.GET, classURL(Royalty.class), params, RoyaltyCollection.class);
    }
    ...
    public static RoyaltyCollection batchUpdate(Map<String, Object> params)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.PUT, classURL(Royalty.class), params, RoyaltyCollection.class);
    }
}
