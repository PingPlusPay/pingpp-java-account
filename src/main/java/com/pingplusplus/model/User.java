...
public class User extends AppBasedResource {
    ...
    public static User retrieve(String id)
            ...
            APIConnectionException, APIException, ChannelException, RateLimitException {
        User.checkUserId(id);
        return request(RequestMethod.GET, instanceURL(User.class, id), null, User.class);
    }
    ...
    public static UserCollection list(Map<String, Object> params)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.GET, classURL(User.class), params, UserCollection.class);
    }
    ...
    public static User update(String id, Map<String, Object>params)
            ...
            APIConnectionException, APIException, ChannelException, RateLimitException {
        User.checkUserId(id);
        return request(RequestMethod.PUT, instanceURL(User.class, id), params, User.class);
    }
    ...
    public static BalanceTransaction createBalanceTranfer(String userId, Map<String, Object>params)
        ...
        return request(RequestMethod.POST, String.format("%s/transfers", instanceURL(User.class, userId)), params, BalanceTransaction.class);
    }
