...
public class SubApp extends AppBasedResource {
    ...
    public static SubApp create(Map<String, Object>params)
        ...
        return request(RequestMethod.POST, classURL(SubApp.class), params, SubApp.class);
    }
    ...
    public static SubApp retrieve(String id)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.GET, instanceURL(SubApp.class, id), null, SubApp.class);
    }
    ...
    public static SubAppCollection list(Map<String, Object> params)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.GET, classURL(SubApp.class), params, SubAppCollection.class);
    }
    ...
    public static SubApp update(String id, Map<String, Object>params)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.PUT, instanceURL(SubApp.class, id), params, SubApp.class);
    }
    ...
    public static DeletedSubApp delete(String id)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.DELETE, instanceURL(SubApp.class, id), null, DeletedSubApp.class);
    }
}
