...
public class BatchWithdrawal extends AppBasedResource {
    ...
    public static BatchWithdrawal create(Map<String, Object> params)
        ...
        return request(RequestMethod.POST, classURL(BatchWithdrawal.class), params, BatchWithdrawal.class);
    }
    ...
    public static BatchWithdrawal retrieve(String id)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.GET, instanceURL(BatchWithdrawal.class, id), null, BatchWithdrawal.class);
    }
    ...
    public static BatchWithdrawalCollection list(Map<String, Object> params)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.GET, classURL(BatchWithdrawal.class), params, BatchWithdrawalCollection.class);
    }
}
