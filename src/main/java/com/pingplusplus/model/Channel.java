...
public class Channel extends SubAppBasedResource {
    ...
    public static Channel create(String subAppId, Map<String, Object>params)
        ...
        return request(RequestMethod.POST, classURL(Channel.class, subAppId), params, Channel.class);
    }
    ...
    public static Channel retrieve(String subAppId, String channel)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.GET, instanceURL(Channel.class, subAppId, channel), null, Channel.class);
    }
    ...
    public static Channel update(String subAppId, String channel, Map<String, Object>params)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.PUT, instanceURL(Channel.class, subAppId, channel), params, Channel.class);
    }
    ...
    public static DeletedChannel delete(String subAppId, String channel)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.DELETE, instanceURL(Channel.class, subAppId, channel), null, DeletedChannel.class);
    }
}
