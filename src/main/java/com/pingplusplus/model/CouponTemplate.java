...
public class CouponTemplate extends AppBasedResource {
    ...
    public static CouponTemplate create(Map<String, Object>params)
        ...
        return request(RequestMethod.POST, classURL(CouponTemplate.class), params, CouponTemplate.class);
    }
    ...
    public static CouponTemplate retrieve(String id)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.GET, instanceURL(CouponTemplate.class, id), null, CouponTemplate.class);
    }
    ...
    public static CouponTemplateCollection list(Map<String, Object> params)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.GET, classURL(CouponTemplate.class), params, CouponTemplateCollection.class);
    }
    ...
    public static CouponTemplate update(String id, Map<String, Object>params)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.PUT, instanceURL(CouponTemplate.class, id), params, CouponTemplate.class);
    }
    ...
    public static DeletedCouponTemplate delete(String id)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.DELETE, instanceURL(CouponTemplate.class, id), null, DeletedCouponTemplate.class);
    }
    ...
    public static CouponCollection createCoupons(String id, Map<String, Object>params)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.POST, couponsURL(id), params, CouponCollection.class);
    }
    ...
    public static CouponCollection listCoupons(String id, Map<String, Object>params)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.GET, couponsURL(id), params, CouponCollection.class);
    }
}
