...
public class BalanceTransfer extends AppBasedResource {
    ...
    public static BalanceTransfer create(Map<String, Object> params)
        ...
        return request(RequestMethod.POST, classURL(BalanceTransfer.class), params, BalanceTransfer.class);
    }
    ...
    public static BalanceTransfer retrieve(String id)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.GET, instanceURL(BalanceTransfer.class, id), null, BalanceTransfer.class);
    }
    ...
    public static BalanceTransferCollection list(Map<String, Object> params)
            throws AuthenticationException, InvalidRequestException,
            APIConnectionException, APIException, ChannelException, RateLimitException {
        return request(RequestMethod.GET, classURL(BalanceTransfer.class), params, BalanceTransferCollection.class);
    }
}
